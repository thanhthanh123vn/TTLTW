...
@WebServlet(name = "ViewImportReceiptServlet", urlPatterns = {"/ViewImportReceipt"})
public class ViewImportReceiptServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/admin/ViewImportReceipt.jsp").forward(request, response);
